      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              onClick={handleCart}
              className=" relative text-gray-700 hover:text-blue-600 p-2 rounded-lg  hover:bg-gray-100 transition-colors"
            >
              <ShoppingCart size={20} />
              {itemCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-4 px-1 rounded-full bg-red-500 text-white text-xs font-medium justify-center items-center shadow">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t">
          <div className="px-4 py-2 space-y-1">
            ...
            {!User.isAuthenticated && (
              <button className="block px-3 py-2 text-gray-700 hover:bg-gray-100 rounded">
                Login
              </button>
            )}
            {!User.isAuthenticated && (
